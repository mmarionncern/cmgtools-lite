...
triggers_MT2_mumu = ["HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v*", "HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v*", "HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_v*", "HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_v*"]
...
triggers_MT2_mu = ["HLT_IsoMu17_eta2p1_v*","HLT_IsoMu20_eta2p1_v*", "HLT_IsoMu20_v*", "HLT_IsoTkMu20_v*", "HLT_IsoTkMu20_eta2p1_v*", "HLT_IsoMu24_v", "HLT_IsoTkMu24_v"]
triggers_MT2_e = ["HLT_Ele23_WPLoose_Gsf_v*", "HLT_Ele22_eta2p1_WPLoose_Gsf_v*","HLT_Ele22_eta2p1_WP75_Gsf_v*", "HLT_Ele23_WP75_Gsf_v*", "HLT_Ele25_eta2p1_WPTight_Gsf_v*"]
...
triggers_HT300_MET100 = ["HLT_PFHT300_PFMET100_v*"]
triggers_HT300_MET110 = ["HLT_PFHT300_PFMET110_v*"]

triggers_HT125 = ["HLT_PFHT125_v*"] # prescaled
...
triggers_met100_mht100 = ["HLT_PFMET100_PFMHT100_IDTight_v*"]
triggers_met110_mht110 = ["HLT_PFMET110_PFMHT110_IDTight_v*"]
